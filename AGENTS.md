...
- When giving bugs/issues, you should either provide root causes or provide available solutions. If you are not able to provide suitable solutions, you should consider that if it is a realworld bug/issue.
